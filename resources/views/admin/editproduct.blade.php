            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('updateproduct') }}" method="POST" >
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Deskripsi Pendek Produk</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="product_short_des"
                                id="product_short_des" cols="30" rows="10">{{$productinfo->product_short_des}}</textarea>
                                {{-- {{- <input type="text" class="form-control" id="product_short_des" name="product_short_des"
                                    value="{{$productinfo->product_long_des}}" /> -}} --}}
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-name">Deskripsi Panjang Produk</label>
                            <div class="col-sm-10">
